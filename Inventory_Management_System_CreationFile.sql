...
/****** Object:  Database [Inventory_Management_System]    Script Date: 11/13/2023 4:30:47 PM ******/
CREATE DATABASE [Inventory_Management_System]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'Inventory_Management_System', FILENAME = N'F:\SQL Server\MSSQL16.SQLEXPRESS01\MSSQL\DATA\Inventory_Management_System.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'Inventory_Management_System_log', FILENAME = N'F:\SQL Server\MSSQL16.SQLEXPRESS01\MSSQL\DATA\Inventory_Management_System_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [Inventory_Management_System] SET RECOVERY SIMPLE 
GO
